Shader "StylizedGuns/PlasmInner"
{
	Properties
	{
		_AnimationSpeed("Animation Speed", Float) = 6.8
		_AnimationScale("Animation Scale", Float) = 0.04
		_FlickerIntensity("Flicker Intensity", Float) = 1
		[HDR]_FresnelColor("Fresnel Color", Color) = (0.4784314,0,1.498039,0.2784314)
		_FresnelPower("Fresnel Power", Float) = 10
		[HDR]_InnerColor("Inner Color", Color) = (1.231373,0.3607843,1.960784,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_1_0_g2 = ( _FlickerIntensity * _Time.y );
			float fresnelNdotV74 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode74 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV74, ( ( ( ( temp_output_1_0_g2 - floor( ( temp_output_1_0_g2 + 0.5 ) ) ) * 2 ) * _FresnelPower ) + 13.0 ) ) );
			o.Albedo = ( _InnerColor + ( _FresnelColor * fresnelNode74 ) ).rgb;
			o.Alpha = 1;
		}
