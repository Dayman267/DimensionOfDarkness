Shader "Zololgo/Sci-Fi HologramUnscaledTime" 
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _UnscaledTime; // Новая переменная для передачи unscaled времени
            ...
            v2f vert (appdata v)
            {
                ...
                o.scanlines_uv = flicker_uv * _Scanlines_ST.xy + frac(_UnscaledTime*_Scanlines_ST.zw);
                o.scan2_uv = o.scanlines_uv;
                #if SCAN2_ON
                o.scan2_uv = flicker_uv * _Scan2_ST.xy + frac(_UnscaledTime*_Scan2_ST.zw);
                #endif
