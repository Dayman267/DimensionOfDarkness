...
Shader "Nicrom/LPW/ASE/Low Poly Vegetation"
{
	Properties
	{
		...
		[Space]_EmissionColor("Emission Color", Color) = (1, 1, 1, 1)
		
        //[Space]_OutlineColor("Outline Color", Color) = (1, 1, 1, 1)
        //[Space]_OutlineWidth("Outline Width", Range(0, 1)) = 0.02
	}
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			o.worldNormal = WorldNormalVector(v, float3(0, 0, 1));
			
			//v.vertex.xyz += o.worldNormal * _OutlineWidth;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
            ...
            float NdotL = max(0, dot(i.worldNormal, worldLightDir));
            o.Albedo *= NdotL;
